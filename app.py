...
class ExtendedAPI(Api):
    ...
    def handle_error(self, err):
        ...
        if isinstance(err, HTTPException):
            return {
                'success': False,
                'message': getattr(err, 'description', HTTP_STATUS_CODES.get(err.code, ''))
                }, err.code
...
core = Controller(db_url="mysql+mysqlconnector://flask:password@127.0.0.1:3306/pizza_shop")

api.add_resource(ManageFood, '/api/menu/food/<int:entity_id>', resource_class_kwargs={'core': core})
